    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="商城官网">TMall商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
                ...
                <div class="nav-user-wrapper pa" v-if="login">
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li>
                        <router-link to="/user/message">账号资料</router-link>
                      </li>
                      <li>
                      ...
                      <!-- <li>
                        <router-link to="/user/support">我的消息</router-link>
                      </li>
                      <li>
                  ...
                  <div class="nav-user-list">
                    <div class="full">
                      ...
                      <div class="nav-cart-total">
                        ...
                        <h6>
                          <el-button type="danger" @click="tocart"
                            >去购物车</el-button
                          >
                        </h6>
                      </div>
...
export default {
  data() {
    return {
      ...
      breadcrumbs: [
        ...
        {
          word: "手机",
          path: "/goods?cid=mobile",
        },
        {
          word: "配件",
          path: "/goods?cid=parts",
        },
        {
          word: "Lipro",
          path: "/goods?cid=lipro",
        },
        {
          word: "声学",
          path: "/goods?cid=voice",
        },
        {
          word: "其他",
          path: "",
  ...
  async mounted() {
    if (this.login) {
      getCartlist({ userId: getStore("id") }).then((res) => {
        console.log(res);
        if (res.data && res.status === 200) {
          setStore("buyCart", res.data.cartgoods);
          this.INITBUYCART();
        }
      });
    } else {
